...
architecture behav of design_1_v_tpg_0_0_v_tpg is 
    ...
    "design_1_v_tpg_0_0_v_tpg,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu4ev-sfvc784-1-e,HLS_INPUT_CLOCK=13.750000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.801563,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=5,HLS_SYN_DSP=0,HLS_SYN_FF=8486,HLS_SYN_LUT=10849,HLS_VERSION=2023_2}";
    ...
    signal icmp_ln500_fu_720_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln500_reg_803 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal empty_fu_788_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_reg_920 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_109_fu_793_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_109_reg_925 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_110_fu_798_p1 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TKEEP : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TSTRB : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TDEST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_501_fid : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_501_ap_start : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_501_s_axis_video_TREADY : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TVALID : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TREADY : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_501_fid_ap_vld : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_501_ap_done : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_501_ap_ready : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_501_ap_idle : STD_LOGIC;
    signal grp_v_tpgHlsDataFlow_fu_501_ap_continue : STD_LOGIC;
    signal grp_reg_unsigned_short_s_fu_714_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_reg_unsigned_short_s_fu_714_ap_ce : STD_LOGIC;
    signal count_new_0_reg_490 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln503_fu_736_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_501_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal ap_sync_grp_v_tpgHlsDataFlow_fu_501_ap_ready : STD_LOGIC;
    signal ap_sync_grp_v_tpgHlsDataFlow_fu_501_ap_done : STD_LOGIC;
    signal ap_block_state4_on_subcall_done : BOOLEAN;
    signal ap_sync_reg_grp_v_tpgHlsDataFlow_fu_501_ap_ready : STD_LOGIC := '0';
    signal ap_sync_reg_grp_v_tpgHlsDataFlow_fu_501_ap_done : STD_LOGIC := '0';
    signal select_ln505_fu_768_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_fu_746_p4 : STD_LOGIC_VECTOR (28 downto 0);
    signal icmp_ln505_fu_756_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln507_fu_762_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    grp_v_tpgHlsDataFlow_fu_501 : component design_1_v_tpg_0_0_v_tpgHlsDataFlow
    port map (
        ...
        height_val5 => height_read_reg_815,
        width_val10 => width_read_reg_820,
        field_id_val11 => field_id_read_reg_825,
        fid_in_val12 => fid_in,
        passthruStartX_val13 => passthruStartX_read_reg_835,
        passthruStartY_val14 => passthruStartY_read_reg_840,
        passthruEndX_val15 => passthruEndX_read_reg_845,
        passthruEndY_val16 => passthruEndY_read_reg_850,
        enableInput_val18 => enableInput_read_reg_855,
        bckgndId_val19 => bckgndId_read_reg_860,
        ovrlayId_val20 => ovrlayId_read_reg_865,
        maskId_val21 => maskId_read_reg_870,
        motionSpeed_val23 => motionSpeed_read_reg_875,
        colorFormat_val27 => colorFormat_read_reg_880,
        crossHairX_val28 => crossHairX_read_reg_885,
        crossHairY_val29 => crossHairY_read_reg_890,
        ZplateHorContStart_val30 => ZplateHorContStart_read_reg_895,
        ZplateHorContDelta_val31 => ZplateHorContDelta_read_reg_900,
        ZplateVerContStart_val32 => ZplateVerContStart_read_reg_905,
        ZplateVerContDelta_val33 => ZplateVerContDelta_read_reg_910,
        boxSize_val34 => boxSize_read_reg_915,
        boxColorR_val35 => empty_reg_920,
        boxColorG_val36 => empty_109_reg_925,
        boxColorB_val37 => empty_110_reg_930,
        dpDynamicRange_val38 => dpDynamicRange_read_reg_935,
        dpYUVCoef_val39 => dpYUVCoef_read_reg_940,
        m_axis_video_TDATA => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TDATA,
        m_axis_video_TKEEP => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TKEEP,
        m_axis_video_TSTRB => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TSTRB,
        m_axis_video_TUSER => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TUSER,
        m_axis_video_TLAST => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TLAST,
        m_axis_video_TID => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TID,
        m_axis_video_TDEST => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TDEST,
        fid => grp_v_tpgHlsDataFlow_fu_501_fid,
        s => s,
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ...
        ap_start => grp_v_tpgHlsDataFlow_fu_501_ap_start,
        s_axis_video_TVALID => s_axis_video_TVALID_int_regslice,
        s_axis_video_TREADY => grp_v_tpgHlsDataFlow_fu_501_s_axis_video_TREADY,
        ...
        m_axis_video_TVALID => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TVALID,
        m_axis_video_TREADY => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TREADY,
        fid_ap_vld => grp_v_tpgHlsDataFlow_fu_501_fid_ap_vld,
        ap_done => grp_v_tpgHlsDataFlow_fu_501_ap_done,
        ap_ready => grp_v_tpgHlsDataFlow_fu_501_ap_ready,
        ap_idle => grp_v_tpgHlsDataFlow_fu_501_ap_idle,
        ap_continue => grp_v_tpgHlsDataFlow_fu_501_ap_continue);

    grp_reg_unsigned_short_s_fu_714 : component design_1_v_tpg_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        d => bck_motion_en,
        ap_return => grp_reg_unsigned_short_s_fu_714_ap_return,
        ap_ce => grp_reg_unsigned_short_s_fu_714_ap_ce);
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TDATA,
        vld_in => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TKEEP,
        vld_in => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TSTRB,
        vld_in => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TUSER,
        vld_in => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TLAST,
        vld_in => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TID,
        vld_in => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TVALID,
    ...
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        data_in => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TDEST,
        vld_in => grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TVALID,
    ...
    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_501_ap_done_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_grp_v_tpgHlsDataFlow_fu_501_ap_done <= ap_const_logic_0;
            else
                if (((ap_const_boolean_0 = ap_block_state4_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_501_ap_done <= ap_const_logic_0;
                elsif ((grp_v_tpgHlsDataFlow_fu_501_ap_done = ap_const_logic_1)) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_501_ap_done <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_501_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_grp_v_tpgHlsDataFlow_fu_501_ap_ready <= ap_const_logic_0;
            else
                if (((ap_const_boolean_0 = ap_block_state4_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_501_ap_ready <= ap_const_logic_0;
                elsif ((grp_v_tpgHlsDataFlow_fu_501_ap_ready = ap_const_logic_1)) then 
                    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_501_ap_ready <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    grp_v_tpgHlsDataFlow_fu_501_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_v_tpgHlsDataFlow_fu_501_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_state3) or ((ap_sync_grp_v_tpgHlsDataFlow_fu_501_ap_ready = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state4)))) then 
                    grp_v_tpgHlsDataFlow_fu_501_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_v_tpgHlsDataFlow_fu_501_ap_ready = ap_const_logic_1)) then 
                    grp_v_tpgHlsDataFlow_fu_501_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
    ...
    count_new_0_reg_490_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln500_fu_720_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                if ((icmp_ln503_fu_736_p2 = ap_const_lv1_0)) then 
                    count_new_0_reg_490 <= add_ln502_fu_730_p2;
                elsif ((icmp_ln503_fu_736_p2 = ap_const_lv1_1)) then 
                    count_new_0_reg_490 <= ap_const_lv32_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                ZplateHorContDelta_read_reg_900 <= ZplateHorContDelta;
                ZplateHorContStart_read_reg_895 <= ZplateHorContStart;
                ZplateVerContDelta_read_reg_910 <= ZplateVerContDelta;
                ZplateVerContStart_read_reg_905 <= ZplateVerContStart;
                bckgndId_read_reg_860 <= bckgndId;
                boxSize_read_reg_915 <= boxSize;
                colorFormat_read_reg_880 <= colorFormat;
                crossHairX_read_reg_885 <= crossHairX;
                crossHairY_read_reg_890 <= crossHairY;
                dpDynamicRange_read_reg_935 <= dpDynamicRange;
                dpYUVCoef_read_reg_940 <= dpYUVCoef;
                empty_109_reg_925 <= empty_109_fu_793_p1;
                empty_110_reg_930 <= empty_110_fu_798_p1;
                empty_reg_920 <= empty_fu_788_p1;
                enableInput_read_reg_855 <= enableInput;
                field_id_read_reg_825 <= field_id;
                height_read_reg_815 <= height;
                maskId_read_reg_870 <= maskId;
                motionSpeed_read_reg_875 <= motionSpeed;
                ovrlayId_read_reg_865 <= ovrlayId;
                passthruEndX_read_reg_845 <= passthruEndX;
                passthruEndY_read_reg_850 <= passthruEndY;
                passthruStartX_read_reg_835 <= passthruStartX;
                passthruStartY_read_reg_840 <= passthruStartY;
                width_read_reg_820 <= width;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln500_reg_803 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                count <= count_new_0_reg_490;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                icmp_ln500_reg_803 <= icmp_ln500_fu_720_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln500_fu_720_p2 = ap_const_lv1_1) and (icmp_ln503_fu_736_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                s <= select_ln505_fu_768_p3;
            end if;
        end if;
    end process;
    ...
    add_ln502_fu_730_p2 <= std_logic_vector(unsigned(count) + unsigned(ap_const_lv32_1));
    add_ln507_fu_762_p2 <= std_logic_vector(unsigned(s) + unsigned(ap_const_lv32_1));
    ...
    ap_block_state4_on_subcall_done_assign_proc : process(ap_sync_grp_v_tpgHlsDataFlow_fu_501_ap_ready, ap_sync_grp_v_tpgHlsDataFlow_fu_501_ap_done)
    begin
                ap_block_state4_on_subcall_done <= ((ap_sync_grp_v_tpgHlsDataFlow_fu_501_ap_ready and ap_sync_grp_v_tpgHlsDataFlow_fu_501_ap_done) = ap_const_logic_0);
    end process;
    ...
    ap_sync_grp_v_tpgHlsDataFlow_fu_501_ap_done <= (grp_v_tpgHlsDataFlow_fu_501_ap_done or ap_sync_reg_grp_v_tpgHlsDataFlow_fu_501_ap_done);
    ap_sync_grp_v_tpgHlsDataFlow_fu_501_ap_ready <= (grp_v_tpgHlsDataFlow_fu_501_ap_ready or ap_sync_reg_grp_v_tpgHlsDataFlow_fu_501_ap_ready);
    empty_109_fu_793_p1 <= boxColorG(8 - 1 downto 0);
    empty_110_fu_798_p1 <= boxColorB(8 - 1 downto 0);
    empty_fu_788_p1 <= boxColorR(8 - 1 downto 0);
    fid <= grp_v_tpgHlsDataFlow_fu_501_fid;

    grp_reg_unsigned_short_s_fu_714_ap_ce_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) or ((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1)))) then 
            grp_reg_unsigned_short_s_fu_714_ap_ce <= ap_const_logic_1;
        else 
            grp_reg_unsigned_short_s_fu_714_ap_ce <= ap_const_logic_0;
        end if; 
    end process;


    grp_v_tpgHlsDataFlow_fu_501_ap_continue_assign_proc : process(ap_CS_fsm_state4, ap_block_state4_on_subcall_done)
    begin
        if (((ap_const_boolean_0 = ap_block_state4_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
            grp_v_tpgHlsDataFlow_fu_501_ap_continue <= ap_const_logic_1;
        else 
            grp_v_tpgHlsDataFlow_fu_501_ap_continue <= ap_const_logic_0;
        end if; 
    end process;

    grp_v_tpgHlsDataFlow_fu_501_ap_start <= grp_v_tpgHlsDataFlow_fu_501_ap_start_reg;
    grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TREADY <= (m_axis_video_TREADY_int_regslice and ap_CS_fsm_state4);
    icmp_ln500_fu_720_p2 <= "1" when (grp_reg_unsigned_short_s_fu_714_ap_return = ap_const_lv16_1) else "0";
    icmp_ln503_fu_736_p2 <= "1" when (add_ln502_fu_730_p2 = ap_const_lv32_A) else "0";
    icmp_ln505_fu_756_p2 <= "1" when (signed(tmp_1_fu_746_p4) < signed(ap_const_lv29_1)) else "0";
    m_axis_video_TVALID <= regslice_both_m_axis_video_V_data_V_U_vld_out;
    m_axis_video_TVALID_int_regslice <= grp_v_tpgHlsDataFlow_fu_501_m_axis_video_TVALID;
    s_axis_video_TREADY <= regslice_both_s_axis_video_V_data_V_U_ack_in;

    s_axis_video_TREADY_int_regslice_assign_proc : process(grp_v_tpgHlsDataFlow_fu_501_s_axis_video_TREADY, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
            s_axis_video_TREADY_int_regslice <= grp_v_tpgHlsDataFlow_fu_501_s_axis_video_TREADY;
        else 
            s_axis_video_TREADY_int_regslice <= ap_const_logic_0;
        end if; 
    end process;

    select_ln505_fu_768_p3 <= 
        add_ln507_fu_762_p2 when (icmp_ln505_fu_756_p2(0) = '1') else 
        ap_const_lv32_0;
    tmp_1_fu_746_p4 <= s(31 downto 3);
end behav;
