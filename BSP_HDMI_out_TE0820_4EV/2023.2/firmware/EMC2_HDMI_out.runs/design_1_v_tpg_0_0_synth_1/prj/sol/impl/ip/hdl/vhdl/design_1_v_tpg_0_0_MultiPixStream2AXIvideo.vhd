...
attribute shreg_extract : string;
    ...
    signal fid_in_val12_read_reg_298 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln979_fu_221_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln979_reg_326 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln979_fu_255_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln979_1_fu_244_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln928_fu_206_p1 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    port map (
        ...
        empty => empty_reg_149,
        cols => cols_reg_308,
        fid_in_val12_load => fid_in_val12_read_reg_298,
        ...
        colorFormat_val27_load => colorFormat_val27_read_reg_293,
        ...
        field_id_val11_load => field_id_val11_read_reg_303,
        sub_i => sub_i_reg_321,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln979_1_fu_244_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln979_1_fu_244_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln979_1_fu_244_p2 = ap_const_lv1_0))) then 
                i_fu_100 <= i_2_fu_249_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                and_ln979_reg_334 <= and_ln979_fu_255_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then
                colorFormat_val27_read_reg_293 <= colorFormat_val27_dout;
                cols_reg_308 <= width_val10_dout;
                fid_in_val12_read_reg_298 <= fid_in_val12_dout;
                field_id_val11_read_reg_303 <= field_id_val11_dout;
                icmp_ln979_reg_326 <= icmp_ln979_fu_221_p2;
                rows_reg_313 <= height_val5_dout;
                sub_i_reg_321 <= sub_i_fu_215_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln979_1_fu_244_p2 = ap_const_lv1_1))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, ap_block_state1, ap_CS_fsm_state2, grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_981_2_fu_171_ap_done, icmp_ln979_1_fu_244_p2, ap_CS_fsm_state3)
    begin
        case ap_CS_fsm is
    ...
    and_ln979_fu_255_p2 <= (sof_reg_159 and icmp_ln979_reg_326);
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state2, icmp_ln979_1_fu_244_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln979_1_fu_244_p2 = ap_const_lv1_1))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln979_1_fu_244_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln979_1_fu_244_p2 = ap_const_lv1_1))) then 
    ...
    i_2_fu_249_p2 <= std_logic_vector(unsigned(i_fu_100) + unsigned(ap_const_lv10_1));
    icmp_ln979_1_fu_244_p2 <= "1" when (i_fu_100 = rows_reg_313) else "0";
    icmp_ln979_fu_221_p2 <= "1" when (width_val10_dout = ap_const_lv11_0) else "0";
    m_axis_video_TDATA <= grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_981_2_fu_171_m_axis_video_TDATA;
    m_axis_video_TDEST <= grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_981_2_fu_171_m_axis_video_TDEST;
    m_axis_video_TID <= grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_981_2_fu_171_m_axis_video_TID;
    m_axis_video_TKEEP <= grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_981_2_fu_171_m_axis_video_TKEEP;
    ...
    sub_i_fu_215_p2 <= std_logic_vector(unsigned(zext_ln928_fu_206_p1) + unsigned(ap_const_lv12_FFF));
    ...
    zext_ln928_fu_206_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(width_val10_dout),12));
end behav;
