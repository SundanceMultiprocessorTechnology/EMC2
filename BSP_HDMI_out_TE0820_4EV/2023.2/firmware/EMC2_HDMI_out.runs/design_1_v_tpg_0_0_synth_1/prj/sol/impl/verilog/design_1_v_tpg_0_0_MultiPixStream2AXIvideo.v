...
reg   [7:0] colorFormat_val27_read_reg_293;
reg    ap_block_state1;
reg   [0:0] fid_in_val12_read_reg_298;
reg   [15:0] field_id_val11_read_reg_303;
reg   [10:0] cols_reg_308;
reg   [9:0] rows_reg_313;
wire   [11:0] sub_i_fu_215_p2;
reg   [11:0] sub_i_reg_321;
wire   [0:0] icmp_ln979_fu_221_p2;
reg   [0:0] icmp_ln979_reg_326;
wire   [0:0] and_ln979_fu_255_p2;
...
wire   [0:0] icmp_ln979_1_fu_244_p2;
wire    ap_CS_fsm_state3;
reg   [15:0] counter_loc_0_i_fu_104;
reg   [0:0] p_phi_i_loc_fu_108;
reg   [9:0] i_fu_100;
wire   [9:0] i_2_fu_249_p2;
reg   [0:0] fid_preg;
wire   [11:0] zext_ln928_fu_206_p1;
reg   [3:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln979_1_fu_244_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln979_1_fu_244_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        i_fu_100 <= 10'd0;
    end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln979_1_fu_244_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln979_1_fu_244_p2 == 1'd1))) begin
...
assign and_ln979_fu_255_p2 = (sof_reg_159 & icmp_ln979_reg_326);
...
assign i_2_fu_249_p2 = (i_fu_100 + 10'd1);

assign icmp_ln979_1_fu_244_p2 = ((i_fu_100 == rows_reg_313) ? 1'b1 : 1'b0);

assign icmp_ln979_fu_221_p2 = ((width_val10_dout == 11'd0) ? 1'b1 : 1'b0);
...
assign sub_i_fu_215_p2 = ($signed(zext_ln928_fu_206_p1) + $signed(12'd4095));

assign zext_ln928_fu_206_p1 = width_val10_dout;
