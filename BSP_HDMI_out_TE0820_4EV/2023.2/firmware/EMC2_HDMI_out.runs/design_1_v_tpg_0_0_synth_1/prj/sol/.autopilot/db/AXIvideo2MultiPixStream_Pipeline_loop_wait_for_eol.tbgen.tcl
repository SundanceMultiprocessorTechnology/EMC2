...
set C_modelArgList {
	{ axi_data_7_reload int 24 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "axi_data_7_reload", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ axi_data_7_reload sc_in sc_lv 24 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_7_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "axi_data_7_reload", "role": "default" }} , 
...
set Spec2ImplPortList { 
	axi_data_7_reload { ap_none {  { axi_data_7_reload in_data 0 24 } } }
