...
set C_modelArgList {
	...
	{ height_val5_c int 10 regular {fifo 1}  }
	{ width_val10_c int 11 regular {fifo 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bckgndYUV", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "height_val5_c", "interface" : "fifo", "bitwidth" : 10, "direction" : "WRITEONLY"} , 
 	{ "Name" : "width_val10_c", "interface" : "fifo", "bitwidth" : 11, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ height_val5_c_din sc_out sc_lv 10 signal 14 } 
	...
	{ width_val10_c_din sc_out sc_lv 11 signal 15 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "height_val5_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "height_val5_c", "role": "din" }} , 
 	...
 	{ "name": "width_val10_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "width_val10_c", "role": "din" }} , 
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "1", "Max" : "196605"}
]}
...
set Spec2ImplPortList { 
	...
	height_val5_c { ap_fifo {  { height_val5_c_din fifo_data_in 1 10 }  { height_val5_c_num_data_valid fifo_status_num_data_valid 0 3 }  { height_val5_c_fifo_cap fifo_update 0 3 }  { height_val5_c_full_n fifo_status 0 1 }  { height_val5_c_write fifo_port_we 1 1 } } }
	width_val10_c { ap_fifo {  { width_val10_c_din fifo_data_in 1 11 }  { width_val10_c_num_data_valid fifo_status_num_data_valid 0 3 }  { width_val10_c_fifo_cap fifo_update 0 3 }  { width_val10_c_full_n fifo_status 0 1 }  { width_val10_c_write fifo_port_we 1 1 } } }
	colorFormat_val27_c { ap_fifo {  { colorFormat_val27_c_din fifo_data_in 1 8 }  { colorFormat_val27_c_num_data_valid fifo_status_num_data_valid 0 3 }  { colorFormat_val27_c_fifo_cap fifo_update 0 3 }  { colorFormat_val27_c_full_n fifo_status 0 1 }  { colorFormat_val27_c_write fifo_port_we 1 1 } } }
}
