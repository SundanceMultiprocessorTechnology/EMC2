...
architecture behav of design_1_v_tpg_0_0_v_tpg is 
    ...
    "design_1_v_tpg_0_0_v_tpg,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu4ev-sfvc784-1-e,HLS_INPUT_CLOCK=13.750000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.930292,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=13,HLS_SYN_DSP=0,HLS_SYN_FF=6568,HLS_SYN_LUT=8661,HLS_VERSION=2022_2}";
    ...
    signal icmp_ln455_fu_579_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln455_reg_647 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal add_ln457_fu_589_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_349_fid_in : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TDATA : STD_LOGIC_VECTOR (23 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TKEEP : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TSTRB : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal grp_reg_unsigned_short_s_fu_573_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_reg_unsigned_short_s_fu_573_ap_ce : STD_LOGIC;
    signal count_new_0_reg_338 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln458_fu_595_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_done : STD_LOGIC;
    ...
    signal select_ln460_fu_627_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_fu_605_p4 : STD_LOGIC_VECTOR (28 downto 0);
    signal icmp_ln460_fu_615_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln462_fu_621_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    port map (
        ...
        width => width,
        field_id => field_id,
        fid_in => grp_v_tpgHlsDataFlow_fu_349_fid_in,
    ...
    grp_reg_unsigned_short_s_fu_573 : component design_1_v_tpg_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        d => bck_motion_en,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln455_fu_579_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                if ((icmp_ln458_fu_595_p2 = ap_const_lv1_0)) then 
                    count_new_0_reg_338 <= add_ln457_fu_589_p2;
                elsif ((icmp_ln458_fu_595_p2 = ap_const_lv1_1)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln455_reg_647 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                icmp_ln455_reg_647 <= icmp_ln455_fu_579_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln455_fu_579_p2 = ap_const_lv1_1) and (icmp_ln458_fu_595_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                s <= select_ln460_fu_627_p3;
            end if;
        end if;
    end process;
    ...
    add_ln457_fu_589_p2 <= std_logic_vector(unsigned(count) + unsigned(ap_const_lv32_1));
    add_ln462_fu_621_p2 <= std_logic_vector(unsigned(s) + unsigned(ap_const_lv32_1));
    ...
    ap_block_state4_on_subcall_done_assign_proc : process(ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_ready, ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_done)
    begin
                ap_block_state4_on_subcall_done <= ((ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_ready and ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_done) = ap_const_logic_0);
    end process;
    ...
    ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_done <= (grp_v_tpgHlsDataFlow_fu_349_ap_done or ap_sync_reg_grp_v_tpgHlsDataFlow_fu_349_ap_done);
    ...
    fid <= grp_v_tpgHlsDataFlow_fu_349_fid(0);

    grp_reg_unsigned_short_s_fu_573_ap_ce_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) or ((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1)))) then 
            grp_reg_unsigned_short_s_fu_573_ap_ce <= ap_const_logic_1;
        else 
            grp_reg_unsigned_short_s_fu_573_ap_ce <= ap_const_logic_0;
        end if; 
    end process;
    ...
    grp_v_tpgHlsDataFlow_fu_349_fid_in <= (0=>fid_in, others=>'-');
    grp_v_tpgHlsDataFlow_fu_349_m_axis_video_TREADY <= (m_axis_video_TREADY_int_regslice and ap_CS_fsm_state4);
    icmp_ln455_fu_579_p2 <= "1" when (grp_reg_unsigned_short_s_fu_573_ap_return = ap_const_lv16_1) else "0";
    icmp_ln458_fu_595_p2 <= "1" when (add_ln457_fu_589_p2 = ap_const_lv32_A) else "0";
    icmp_ln460_fu_615_p2 <= "1" when (signed(tmp_1_fu_605_p4) < signed(ap_const_lv29_1)) else "0";
    ...
    select_ln460_fu_627_p3 <= 
        add_ln462_fu_621_p2 when (icmp_ln460_fu_615_p2(0) = '1') else 
        ap_const_lv32_0;
    tmp_1_fu_605_p4 <= s(31 downto 3);
end behav;
