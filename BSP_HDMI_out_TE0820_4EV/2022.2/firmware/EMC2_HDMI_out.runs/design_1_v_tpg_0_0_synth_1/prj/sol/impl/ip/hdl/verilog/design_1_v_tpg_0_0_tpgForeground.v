...
wire   [7:0] empty_78_fu_290_p1;
reg   [7:0] empty_78_reg_476;
wire   [0:0] icmp_fu_304_p2;
reg   [0:0] icmp_reg_481;
wire   [7:0] empty_79_fu_310_p1;
reg   [7:0] empty_79_reg_486;
...
design_1_v_tpg_0_0_tpgForeground_Pipeline_VITIS_LOOP_729_2 grp_tpgForeground_Pipeline_VITIS_LOOP_729_2_fu_174(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
assign and4_i_fu_256_p2 = (empty_77_fu_252_p1 & cmp31_i_fu_226_p2);
...
assign empty_77_fu_252_p1 = maskId[0:0];

assign empty_78_fu_290_p1 = boxColorR[7:0];

assign empty_79_fu_310_p1 = boxColorB[7:0];
