...
(* CORE_GENERATION_INFO="design_1_v_tpg_0_0_v_tpg,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu4ev-sfvc784-1-e,HLS_INPUT_CLOCK=13.750000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.930292,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=13,HLS_SYN_DSP=0,HLS_SYN_FF=6568,HLS_SYN_LUT=8661,HLS_VERSION=2022_2}" *)
...
reg   [0:0] icmp_ln455_reg_647;
wire    ap_CS_fsm_state2;
wire   [31:0] add_ln457_fu_589_p2;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_349_fid_in;
...
wire   [31:0] select_ln460_fu_627_p3;
wire   [28:0] tmp_1_fu_605_p4;
wire   [0:0] icmp_ln460_fu_615_p2;
wire   [31:0] add_ln462_fu_621_p2;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln455_reg_647 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln455_fu_579_p2 == 1'd1) & (icmp_ln458_fu_595_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign add_ln462_fu_621_p2 = (s + 32'd1);
...
always @ (*) begin
    ap_block_state4_on_subcall_done = ((ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_ready & ap_sync_grp_v_tpgHlsDataFlow_fu_349_ap_done) == 1'b0);
end
...
assign grp_v_tpgHlsDataFlow_fu_349_fid_in = fid_in;
...
assign icmp_ln458_fu_595_p2 = ((add_ln457_fu_589_p2 == 32'd10) ? 1'b1 : 1'b0);

assign icmp_ln460_fu_615_p2 = (($signed(tmp_1_fu_605_p4) < $signed(29'd1)) ? 1'b1 : 1'b0);
...
assign select_ln460_fu_627_p3 = ((icmp_ln460_fu_615_p2[0:0] == 1'b1) ? add_ln462_fu_621_p2 : 32'd0);

assign tmp_1_fu_605_p4 = {{s[31:3]}};
